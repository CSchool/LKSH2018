...
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 1" "tests/02" 2
echo "Generating test #3"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 2" "tests/03" 3
echo "Generating test #4"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 3" "tests/04" 4
echo "Generating test #5"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 4" "tests/05" 5
echo "Generating test #6"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 5" "tests/06" 6
echo "Generating test #7"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 6" "tests/07" 7
echo "Generating test #8"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 7" "tests/08" 8
echo "Generating test #9"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 8" "tests/09" 9
echo "Generating test #10"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 9" "tests/10" 10
echo "Generating test #11"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 10" "tests/11" 11
echo "Generating test #12"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 11" "tests/12" 12
echo "Generating test #13"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 12" "tests/13" 13
echo "Generating test #14"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 13" "tests/14" 14
echo "Generating test #15"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 14" "tests/15" 15
echo "Generating test #16"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 15" "tests/16" 16
echo "Generating test #17"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 16" "tests/17" 17
echo "Generating test #18"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 17" "tests/18" 18
echo "Generating test #19"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 18" "tests/19" 19
echo "Generating test #20"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 19" "tests/20" 20
echo "Generating test #21"
scripts/gen-input-via-stdout.sh "wine files/hint_gen.exe 20" "tests/21" 21
echo ""
